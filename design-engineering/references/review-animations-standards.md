...
> Source skill `review-animations` (STANDARDS.md) from [emilkowalski/skills](https://github.com/emilkowalski/skills) — the precise values, curves, and rules behind the review. Cite these in findings instead of approximating.
