...
> Source skill `improve-animations` (AUDIT.md) from [emilkowalski/skills](https://github.com/emilkowalski/skills) — the eight audit categories, what to look for in each, and the exact target values to cite in findings and plans.
