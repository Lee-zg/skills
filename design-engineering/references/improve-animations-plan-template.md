...
> Source skill `improve-animations` (PLAN-TEMPLATE.md) from [emilkowalski/skills](https://github.com/emilkowalski/skills) — the structure every plan written by `improve-animations` follows.
...
- Pull every value from [improve-animations-audit.md](improve-animations-audit.md) — never approximate from memory.
