...
> Source skill `apple-design` from [emilkowalski/skills](https://github.com/emilkowalski/skills) — Apple's approach to interface design and fluid, physical motion, translated for the web (gesture-driven UI, spring animations, drag/swipe/sheet interactions, momentum, translucent materials, typography, reduced-motion, and design foundations).
