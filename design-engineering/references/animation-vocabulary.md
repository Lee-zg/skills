...
> Source skill `animation-vocabulary` from [emilkowalski/skills](https://github.com/emilkowalski/skills) — a reverse-lookup glossary that turns a vague description of a web animation or motion effect into its exact term. For naming an effect, not designing or building one.
